...
abstract class SlideCountdownBase extends StatefulWidget {
  const SlideCountdownBase({
    ...
    required this.digitTitlePadding,
    required this.showZeroValue,
    required this.hideFirstDigitZero,
    required this.showDigitTitles,
  ...
  /// text style which will be for all text
  final TextStyle textStyle;

  /// [TextStyle] is a parameter for the separator,
  /// if this is null [SlideCountdown] has a default
  /// text style which will be for the separator
  final TextStyle separatorStyle;

  /// [TextStyle] is a parameter for the digit title,
  /// if this is null [SlideCountdown] has a default
  /// text style which will be for the digit title
  ...
  /// If you overide [StreamDuration] package for stream a duration
